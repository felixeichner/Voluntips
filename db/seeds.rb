VolunText.create(title: "Über diese Seite",
  body: "<h5><strong>Finde Projekte als Volunteer zur Freiwilligenarbeit im Tierschutz und Umweltschutz</strong></h5>
  <p>Auf vielen Reisen habe ich faszinierende Ecken der Erde kennenlernen d&uuml;rfen. Viele dieser Ecken bestehen nur, weil ein empfindliches &Ouml;kosystem drumherum noch funktioniert. Wie viele andere Mitmenschen m&ouml;chte ich zur Bewahrung dieser Systeme beitragen. Du planst einen n&auml;chsten Urlaub, willst neue Winkel unserer Welt entdecken, aber auch etwas bewegen, einen Mehrwert schaffen, mit dem Gef&uuml;hl nach Hause kommen, einen wertvollen Beitrag geleistet zu haben? Sehr gut! Ich habe diese Seite ins Leben gerufen, um dir Projekte vorzustellen, bei denen du genau das erreichen kannst.</p>
  <p>Diese Projekte verschreiben sich dem Umwelt- und Tierschutz. Unter dem Schlagwort Environmental Conservation findest du auch anderweitig im Internet und in B&uuml;chern viele hilfreiche Tipps, im Rahmen von Volunteering, oft auch als Freiwilligenarbeit bezeichnet, deinen Beitrag zum Erhalt unserer Umwelt zu verwirklichen.</p>
  <p>Viel Vergn&uuml;gen beim St&ouml;bern!</p>")
  VolunText.create(title: "Was ist Volunteering?",
  body: "Unter Volunteering versteht man die freiwillige Verpflichtung, ohne Gegenleistung, weder monetär noch anderweitig, Arbeit zu erledigen. Oft findet man hierzu auch die Bezeichnung Freiwilligenarbeit. Gerade im angelsächsischen Raum findet dieses Konzept großen Anklang. Viele Menschen nutzen diese Möglichkeit, sich in neuen Feldern auszuprobieren, Talente auszuleben oder auch einfach für das gute Gefühl, sich nützlich zu machen. Ein Volunteer ist an verschiedenen Orten zu finden. So kann er sich in seiner Heimatgemeinde einbringen oder auch von zu Hause aus am Laptop Daten zum Beispiel für Non-Profit-Organisationen auswerten. Andere möchten sich nicht kontinuierlich in ihrem Alltag als Volunteer betätigen, sondern suchen explizit in ihrem Urlaub, für ein Sabatical-Jahr oder für eine Weile nach dem Schul- oder Uniabschluss eine Stelle, bei der sie an einem Projekt abseits ihrer gewohnten Pfade mitarbeiten. Auf dieser Seite möchten wir uns vorrangig mit Projekten letzterer Art im Bereich Natur- und Tierschutz beschäftigen.")
VolunText.create(title: "Warum Volunteering?",
  body: "Zum Volunteering gibt es viele gute Gründe, die bei jedem für sich unterschiedlich ausfallen und gewichtet sein können. Gerade den eigenen Horizont durch die Betätigung in einem ungewohnten Umfeld zu erweitern ist für viele Antrieb, sich für ein Volunteering zu entscheiden. Die hier vorgestellten Projekte verlangen den Freiwilligen oft körperlich harte Arbeit ab, die in ihrem Rhythmus und ihrer Ausgestaltung eine willkommene Abwechslung für viele zu ihrer täglichen Arbeit zu Hause darstellt. Durch die körperliche Arbeit im Gegensatz zu oft eher kopflastiger Betätigung im Alltag finden viele einen Ausgleich und Erholung. Dieser Wechsel lässt oft ganz unbekannte Seiten an einem selber entdecken und führt einen heran, neue Blickwinkel einzunehmen. Dazu sind Teamarbeit und eine positive Arbeitsatmosphäre wichtige Motivatoren für die Arbeit in sozialen oder ökologisch orientierten Projekten. Sich selber besser kennen und verstehen lernen festigt die Wahrnehmung der eigenen Person und baut somit Selbstvertrauen auf. Hierzu trägt sehr gut bei, dass man in einem ungewohnten Umfeld selber viel dazulernt und neue Kenntnisse und Fertigkeiten erwirbt. Auch das Gefühl, durch die eigene Arbeit etwas zu bewegen und einen wichtigen Beitrag, zum Beispiel zum Schutz einer bestimmten Tierart, zu leisten, ist für viele Hauptmotivation. Oftmals kann am Ende eines Tages direkt das Ergebnis harter Arbeit der letzten Stunden beobachtet und somit ein greifbarer Erfolg genossen werden.")
VolunText.create(title: "Checkliste",
...
Accom.create(name: "Eigenorganisation", category: "Zimmerart")
Accom.create(name: "Gastfamilie", category: "Zimmerart")
Accom.create(name: "Mehrbettzimmer/Schlafsaal", category: "Zimmerart")
Accom.create(name: "Doppelzimmer", category: "Zimmerart")
Accom.create(name: "Einzelzimmer", category: "Zimmerart")
Accom.create(name: "Zelt", category: "Zimmerart")
Accom.create(name: "Ventilator im Zimmer", category: "Zimmermerkmal")
Accom.create(name: "Gemeinschaftsräume", category: "Zimmermerkmal")
Accom.create(name: "Verpflegung inklusive", category: "Zimmermerkmal")
Accom.create(name: "Warmwasser", category: "Ausstattung")
Accom.create(name: "Fließend Wasser", category: "Ausstattung")
Accom.create(name: "Elektrizität", category: "Ausstattung")
Accom.create(name: "Internet", category: "Ausstattung")
Accom.create(name: "Telefon", category: "Ausstattung")
Accom.create(name: "Waschmaschine", category: "Ausstattung")
Accom.create(name: "Freizeitaktivitäten in direkter Umgebung", category: "Sonstiges")
Accom.create(name: "Soziale Infrastruktur in direkter Umgebung", category: "Sonstiges")
Accom.create(name: "Strandlage", category: "Sonstiges")
Accom.create(name: "Sichere Umgebung", category: "Sonstiges")

Animal.create(name: "Landschildkröte", terrain: "Land")
Animal.create(name: "Meeresschildkröte", terrain: "Wasser")
Animal.create(name: "Wal", terrain: "Wasser")
Animal.create(name: "Delfin", terrain: "Wasser")
Animal.create(name: "Hai", terrain: "Wasser")
Animal.create(name: "Fledermaus", terrain: "Luft")
Animal.create(name: "Flughund", terrain: "Luft")
Animal.create(name: "Affe", terrain: "Land")
Animal.create(name: "Löwe", terrain: "Land")
Animal.create(name: "Leopard", terrain: "Land")
Animal.create(name: "Jaguar", terrain: "Land")
Animal.create(name: "Puma", terrain: "Land")
Animal.create(name: "Tapir", terrain: "Land")
Animal.create(name: "Afrikanischer Wildhund", terrain: "Land")
Animal.create(name: "Hund", terrain: "Land")
Animal.create(name: "Katze", terrain: "Land")
Animal.create(name: "Orang Utan", terrain: "Land")
Animal.create(name: "Nasenbär", terrain: "Land")
Animal.create(name: "Küstenwald", terrain: "Landschaft")
Animal.create(name: "Lemur", terrain: "Land")
Animal.create(name: "Bär", terrain: "Land")
Animal.create(name: "Krokodil", terrain: "Wasser")
Animal.create(name: "Vogel", terrain: "Luft")
...
Country.create(name: "Bolivien", region1: "Südamerika")
Country.create(name: "Borneo", region1: "Asien")
...
Country.create(name: "Kenia", region1: "Afrika")
Country.create(name: "Madagaskar", region1: "Afrika")
Country.create(name: "Spanien", region1: "Europa")
Country.create(name: "Südafrika", region1: "Afrika")
Country.create(name: "USA", region1: "Nordamerika")

Task.create(name: "Deutsch", category: "Sprache")
Task.create(name: "Englisch", category: "Sprache")
Task.create(name: "Spanisch", category: "Sprache")
Task.create(name: "Französisch", category: "Sprache")
Task.create(name: "Indonesisch", category: "Sprache")
Task.create(name: "Arbeit direkt am Tier", category: "Aufgabe")
Task.create(name: "Wilde Tiere suchen", category: "Aufgabe")
Task.create(name: "Landschaftspflege", category: "Aufgabe")
Task.create(name: "Pflanzen/Bäume ziehen / Aufforsten", category: "Aufgabe")
Task.create(name: "Arbeit an Landschaft und Tier", category: "Aufgabe")
Task.create(name: "Instandhaltungs-/Bauarbeiten", category: "Aufgabe")
Task.create(name: "Kochen/Küchenarbeit", category: "Aufgabe")
Task.create(name: "Administrative Arbeit", category: "Aufgabe")
Task.create(name: "Leitende Aufgaben", category: "Aufgabe")
Task.create(name: "Wanderungen", category: "Aktivität")
Task.create(name: "Fotografieren/Filmen", category: "Aktivität")
Task.create(name: "Beobachtungen per Auto", category: "Aktivität")
Task.create(name: "Beobachtungen per Boot", category: "Aktivität")
Task.create(name: "Tauchen", category: "Aktivität")
Task.create(name: "Datenauswertung", category: "Aufgabe")
Task.create(name: "Unterricht/Aufklärung", category: "Aktivität")
Task.create(name: "Betreuung von Besuchern", category: "Aktivität")
Task.create(name: "Strandlage", category: "Sonstiges")
Task.create(name: "Geregelte Arbeitszeiten", category: "Sonstiges")
Task.create(name: "Arbeit nur tagsüber", category: "Sonstiges")
Task.create(name: "Nachtdienst nur in Notfällen", category: "Sonstiges")
Task.create(name: "Anerkennung für Studium", category: "Sonstiges")
Task.create(name: "Besonderer Einsatz für Tiermediziner", category: "Sonstiges")

Project.create(title: "Bahamas Marine Conservation, Bahamas", preview: "Korallenriffe und Meerestiere schützen",
  summary: "Der Bahamas National Trust studiert Korallenriffe vor der heimischen Küste und unterrichtet an den örtlichen Grundschulen, um das marine Ökosystem auch in Zukunft weiter schützen zu können. Hierbei erhalten Volunteers die Möglichkeit, nicht nur viel zur Unterwasserwelt, sondern auch tauchen zu lernen und ausgiebig zu praktizieren.",
  qualification: "Körperliche Fitness für Tauchgänge, eine hohe Lernbereitschaft und die Fähigkeit im Team zu arbeiten, sind für dieses Projekt essentiell.",
  work: "In diversen Kursen erlangen Volunteers PADI-Tauchscheine, um regelmäßig Korallenriffe in Tauchgängen zu studieren und zu erforschen. Einmal wöchentlich geben sie zusätzlich an einer örtlichen Grundschule Unterricht, um über die lokale Unterwasserwelt und deren Schutz aufzuklären.",
  accomodation: "Mehrbettzimmer in idyllisch am Strand gelegenen Holzhäusern bieten den Mitarbeitern Unterkunft. Gemeinschaftsräume und Küchen sind ebenfalls vorhanden. Ein Gemeinschaftsleben wird explizit gefördert.",
  costs: "Ab 890 GBP für zwei Wochen inklusive Unterbringung, Verpflegung, Tauchausrüstung und Tauchgängen sowie Flughafentransfers, je nach Ausbildungsstand werden Tauchkurse extra berechnet. Aufenthaltsdauer normal vier bis zehn Wochen",
  address: "The Greenforce Foundation\n
  21 Heathmans Road\n
  London SW6 4TJ\n
  United Kingdom",
...
Project.create(title: "Arcas, Hawaii, Guatemala", preview: "Meeresschildkröten retten und erforschen",
  ...
  qualification: "Spanischkenntnisse sind von Vorteil und empfehlenswert, um besser mit der lokalen Bevölkerung in einen Austausch zu kommen. Zwingend vorgeschrieben ist die Beherrschung des Spanischen aber nicht. Da die Arbeit hauptsächlich nachts zu erledigen ist, sollte einem der eigene Nachtschlaf nicht zu wichtig sein.",
  work: "Auf etwa zwei- bis vierstündigen nächtlichen Patrouillengänge suchen die Volunteers nach Eier legenden Schildkröten am Strand und verbuddeln nach der Ablage die Eier im geschützten Areal des Projektes. Das Vermessen, Wiegen und Auswildern der frisch Geschlüpften gehört genauso zur nächtlichen Tätigkeit wie weitere Forschungsarbeiten. Tagsüber kann man bei ausreichenden Sprachkenntnissen die Aufklärungsarbeit von Besuchern unterstützen.",
  accomodation: "Auf drei nahe dem Projekt gelegene Häuser aufgeteilt übernachten die Teilnehmer in Stockbetten. Schließfächer und Ventilatoren sind in allen drei Häusern vorhanden. Moskitonetze bieten nachts Schutz beim Schlafen. Insgesamt sind die Unterkünfte rustikal, aber gemütlich.",
  costs: "USD 175 pro Woche inklusive Unterbringung und Verpflegung",
  address: "Parque Hawaii\n
  Aldea Hawaii, Chiquimulilla, Santa Rosa\n
  Guatemala",
  tel: "+502 3105 8965", email: "arcasvolunteers@gmail.com",
  webpage: "http://www.arcasguatemala.com/where-we-are/arcas-hawaii/",
  min_weeks: 0, costs_week: 160, accom_standard: "einfach", lat: "13.866211", lgt: "-90.411340",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Ventilator im Zimmer']),
...
Project.create(title: "M.E.E.R. e.V., La Gomera, Spanien", preview: "Delfine und Wale beobachten und studieren",
  ...
  qualification: "An dem Projekt kann jeder Delfin- und Walinteressierte teilnehmen. Vorkenntnisse sind nicht erforderlich. Kurse und Arbeit finden in Englisch statt. Da es sich um feste Kurse handelt, können Biologiestudenten versuchen, sich den Aufenthalt für das Studium anrechnen zu lassen. Die Humboldt-Universität Berlin sowie die Universität Wien haben die Teilnahme in der Vergangenheit bereits anerkannt.",
  work: "Die Aufgaben gehen von der Sammlung von Daten auf den Whale-Watching-Booten bis zu deren Auswertung. Dazu kommen Vorträge zum Erweitern des theoretischen Wissens und ausführliche Einweisungen in die Arbeit, da z.B. mit Seekarten und Datenbanken gearbeitet wird.",
  accomodation: "Die Teilnehmer werden normal in Apartments mit 2-Bett-Zimmern der Touristenklasse untergebracht. Gegen Aufpreis kann bei Verfügbarkeit auch ein Einzel- oder Doppelapartment gebucht werden.",
  costs: "899 EUR pro Person für 15 Tage",
  address: "M.E.E.R. e.V. Berlin\n
  Bundesallee 123\n
  12161 Berlin",
  tel: "+49 30 6449 7230", email: "info@m-e-e-r.de", webpage: "http://www.m-e-e-r.de/",
  min_weeks: 2, costs_week: 450, accom_standard: "mittel", lat: "28.081361", lgt: "-17.333772",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Einzelzimmer']),
...
Project.create(title: "African Impact, Gansbaai, Südafrika", preview: "Weiße Haie studieren und pflegen",
  ...
  qualification: "Die Teilnehmer sollten fit sein und körperliche Anstrengung nicht scheuen. Da die meiste Zeit des Tages auf dem Boot verbracht wird, sollte man nicht zu schnell seekrank werden.",
  work: "Die Teilnehmer sind in alle Phasen des Projektes integriert. Somit gehören zu den Aufgaben das Sammeln von Daten wie Geschlecht, Größe und Verhalten der Weißen Haie, die Beobachtung vom Boot aus und das Tauchen mit den Tieren in sicheren Käfigen. Genau erlernt man aber auch Grundlagen der Schifffahrt, des Filmens und Fotografierens unter Wasser sowie zu Artenschutz und der Nutzung des nachhaltigen Tourismus.",
  accomodation: "Die Teilnehmer werden in einem Haus in einer großen Wohngemeinschaft direkt am Meer untergebracht. Die Unterkunft ist von gehobenem Standard mit Pool im Garten, Küche, Esszimmer und einem Gemeinschaftsraum mit Fernseher und Gesellschaftsspielen. Das Haus liegt in einem sehr sicheren Wohngebiet, so dass man sich unbesorgt draußen tags und nachts aufhalten kann.",
  costs: "2 Wochen ZAR (Südafrikanische Rand) 13.615\n
  12 Wochen ZAR 62.188\n
  Die Dauer kann individuell vereinbart werden, sollte aber zwei Wochen nicht unterschreiten.",
  address: "17 Carlton Close\n
  Sunnydale, Noordhoek\n
  Cape Town\n
  South Africa",
  tel: "+27 87 751 3977", email: "info@africanimpact.com", webpage: "http://www.africanimpact.com/",
  min_weeks: 2, costs_week: 800, accom_standard: "gehoben", lat: "-34.580540", lgt: "19.351753",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Gemeinschaftsräume', 'Strandlage', 'Sichere Umgebung']),
...
Project.create(title: "BatReach, North Queensland, Australien", preview: "Flughunde und Fledermäuse aufziehen",
  ...
  qualification: "Besondere Anforderungen werden nicht gestellt. Eine Tollwutimpfung ist allerdings Voraussetzung zur Mitarbeit.",
  work: "Die Hauptaufgaben bestehen in der Pflege und Instandhaltung der Tiergehege, der Vorbereitung von Mahlzeiten, Fütterung von Kleintieren sowie der Betreuung von Besuchern.",
  accomodation: "Alle Volunteers werden möglichst in Privatzimmern der zur Station gehörigen Unterkunft beherbergt. Um Wäsche wie Verpflegung kümmern sich die Mitarbeiter selber.",
  costs: "Unterkunft und Volunteering sind kostenfrei\n
  Verpflegung muss selber arrangiert und finanziert werden\n
  Drei Wochen Mindestaufenthalt",
  address: "PO Box 300\n
  Kuranda, Queensland 4881\n
  Australia",
  tel: "+61 07 4093 8858", email: "volunteer@batreach.com", webpage: "http://www.batreach.com/",
  min_weeks: 3, costs_week: 0, accom_standard: "einfach", lat: "-16.818912", lgt: "145.636445",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Einzelzimmer']),
...
Project.create(title: "Modisa Wildlife Project, Botswana", preview: "Löwen, Leoparden und Afrikanische Wildhunde",
  ...
  qualification: "Besondere Voraussetzungen musst du für ein Volunteering-Programm bei Modisa nicht erfüllen. Je nach Jahreszeit kann es eine sehr hohe Luftfeuchtigkeit geben und tagsüber sehr heiß werden. Solltest du damit nicht gut zurecht kommen, achte genau auf deine bevorzugte Reisezeit.",
  work: "Die Aufgaben sind sehr vielfältig. Dazu zählen die Instandhaltung der Farm und des Camps und das Vorbereiten der Mahlzeiten für die Tiere und deren Fütterung. Ausfahrten in das Reservat, Wanderungen und die Beobachtung der Flora und Fauna stehen regelmäßig auf dem Plan und erlauben das hautnahe Erleben dieses faszinierenden Ökosystems.",
  accomodation: "Für Übernachtungen sind Zweimannzelte auf einer Holzplattform über der Erde installiert. Duschen und Toiletten sind ebenso vorhanden wie eine voll ausgestattete Küche, eine Bar und ein Essbereich. Ein Solarpanel bietet genug Elektrizität für Licht und das Laden von Kameras. Einmal in der Woche sowie nach der Ankunft im Camp gibt es die Möglichkeit, Internet per WLAN zu nutzen. Wäsche wird per Hand gewaschen, die Utensilien hierfür sind vorhanden. Ein Koch sorgt täglich für abwechslungsreiche Ernährung.",
  costs: "2.295 USD für vier Wochen, inklusive Unterkunft, Verpflegung und einigen Aktivitäten\n
  jede weitere Woche 495 USD\n
  Empfohlener Minimumaufenthalt zwei Wochen",
  address: "P.Bag 114\n
  Suite 3\n
  Maun\n
  Botswana",
...
Project.create(title: "OrangUtan Foundation International (dreiwöchig), Borneo, Indonesien",
  ...
  summary: "Die OFI betreibt in Borneo eine Aufzuchtstation zur Auswilderung verwaister und in Gefangenenschaft, meist als Haustier wenig artgerecht lebender Orang Utans. Sie leistet hierbei einen essentiellen Beitrag zum Bestandschutz dieser äußerst bedrohten Tierart wie auch zur Aufklärung der Bevölkerung in Zusammenarbeit mit Polizei und Behörden. Volunteers können sich in dreiwöchigen Projekten hauptsächlich im Ausbau der Infrastruktur einbringen.",
  qualification: "Mit oder ohne besondere Ausbildung sind Volunteers gerne im OFI-Projekt gesehen. Schweißtreibende Arbeit bei tropischem, schwülen Klima sollte einem allerdings lieber nicht zu viel ausmachen. Bewerber mit einem tiermedizinischen Hintergrund haben zusätzlich die Chance, ein unbezahltes Praktikum zu absolvieren. Englischkenntnisse werden vorausgesetzt. Indonesisch hilft, ist aber nicht notwendig.",
  work: "Bei dreiwöchigen Projekten besteht die Arbeit hauptsächlich im Aufbau und der Erweiterung der Infrastruktur, z.B. im Bau von Brücken oder Fitnessgeräten für junge Orang Utans. Es wird sechs Tage die Woche je etwa acht Stunden vorrangig körperlich anstrengende Arbeit verrichtet, die aber bei durchschnittlicher körperlicher Verfassung ohne Probleme zu leisten sein sollte.",
  accomodation: "Für dreiwöchige Projekte gibt es zwei Arten von Unterkünften, auf die die Teilnehmer nach Bedarf verteilt werden, zum einen provisorische Hütten im Wald, zum anderen feste Hütten der Organisation. Die Unterkünfte inklusive Toiletten und Duschen sind rudimentär, fließend Warmwasser steht nicht bereit.",
  costs: "1.275 USD für drei Wochen",
  address: "824 Wellesley Ave\n
...
Project.create(title: "OrangUtan Foundation International (vier bis sechs Monate), Borneo, Indonesien",
  preview: "Orang Utans großziehen",
  summary: "Die OFI betreibt in Borneo eine Aufzuchtstation zur Auswilderung verwaister und in Gefangenenschaft, meist als Haustier wenig artgerecht lebender Orang Utans. Sie leistet hierbei einen essentiellen Beitrag zum Bestandschutz dieser äußerst bedrohten Tierart wie auch zur Aufklärung der Bevölkerung in Zusammenarbeit mit Polizei und Behörden. Volunteers können sich für vier bis sechs Monate in den unterschiedlichen Bereichen der Aufzucht und Pflege einbringen.",
  qualification: "Mit oder ohne besondere Ausbildung sind Volunteers gerne im OFI-Projekt gesehen. Schweißtreibende Arbeit bei tropischem, schwülen Klima sollte einem allerdings lieber nicht zu viel ausmachen. Bewerber mit einem tiermedizinischen Hintergrund haben zusätzlich die Chance, ein unbezahltes Praktikum zu absolvieren. Englischkenntnisse werden vorausgesetzt. Indonesisch hilft, ist aber nicht notwendig.",
  work: "Die vier- bis sechsmonatigen Engagements haben je nach Themengebiet sehr unterschiedliche Aufgabe. Es kann sich um administrative Organisation genauso wie medizinische Versorgung handeln. Genaue Beschreibungen der Tätigkeiten finden sich auf der Webseite von OFI. Ein Acht-Stunden-Tag ist auch hier regulär.",
  accomodation: "Wer sich langfristig einbringt, wird möglichst in einer einheimischen Gastfamilie untergebracht. Hier kann der Wohnkomfort variieren, man sollte aber keinen Luxus erwarten.",
  costs: "etwa 3.800 USD für sechs Monate",
  address: "824 Wellesley Ave\n
  Los Angeles, CA 90049\n
  USA",
  tel: "+1 310 820 4906", email: "ofivolunteer@gmail.com", webpage: "http://www.orangutan.org/",
...
Project.create(title: "Colobus Conservation, Diani Beach, Kenia",
  ...
  address: "P.O. Box 5380\n
  Diani Beach 80401\n
  Kenya",
  tel: "+254 711 479 453", email: "enquiries@colobusconservation.org", webpage: "http://www.colobusconservation.org/",
  min_weeks: 2, costs_week: 240, accom_standard: "einfach", lat: "-4.344381", lgt: "39.564913",
  accoms: Accom.where(name: ['Englisch', 'Eigenorganisation', 'Mehrbettzimmer/Schlafsaal', 'Ventilator im Zimmer', 'Fließend Wasser', 'Elektrizität', 'Warmwasser', 'Sichere Umgebung', 'Verpflegung inklusive', 'Freizeitaktivitäten in direkter Umgebung', 'Soziale Infrastruktur in direkter Umgebung']),
...
Project.create(title: "Vince Shute Wildlife Sanctuary, Orr, Minnesota, USA", preview: "Schwarzbären studieren",
  ...
  qualification: "Die Arbeit ist teils körperlich recht anstrengend, so dass körperliche Fitness für viele Aufgaben notwendig ist. Die Betreiber des Schutzgebietes gehen aber auf individuelle Bedürfnisse der Volunteers ein. Teilnehmer müssen über 18 Jahre alt sein.",
  work: "Neben Kochen für die Mitarbeiter und Abwaschen kümmern sich die Volunteers hauptsächlich um die Schwarzbären und die Betreuung der Besucher des Schutzgebietes. Dies geht von der Beschaffung von Obst und Nüssen über Bepflanzungen und Holzhacken bis hin zur Frage- und Antwort-Stunde mit Besuchern. Für Studenten mit passendem Fachgebiet bietet Vince Shute auch Praktikastellen an.",
  accomodation: "Die Unterkünfte sind sehr einfach gehalten, ohne fließend Wasser oder Elektrizität. Dafür wird versucht, die Mitarbeiter kostenfrei in den Häusern des Sanctuary zu beherbergen.",
  costs: "Für das Projekt und die Mitarbeit ist kein Beitrag zu leisten. Die Anreise, Verpflegung und Freizeitgestaltung verursacht natürlich dennoch Kosten. Vince Shute bietet allen Mitarbeitern jeden Tag Mahlzeiten kostenfrei an.",
  address: "The American Bear Association\n
  PO Box 77\n
  Orr, MN 55771\n
  USA",
  tel: "+1 218 757 0172", email: "bears@americanbear.org", webpage: "http://www.americanbear.org/",
  min_weeks: 0, costs_week: 0, accom_standard: "einfach", lat: "48.0887057", lgt: "-93.01796759999999",
  accoms: Accom.where(name: ['Verpflegung inklusive', 'Mehrbettzimmer/Schlafsaal', 'Gemeinschaftsräume']),
...
Project.create(title: "Comunidad Inti Wara Yassi, Bolivien", preview: "Affen, Schildkröten, Jaguare und Vögel pflegen und aufziehen",
  ...
  qualification: "In diesen Projekten gilt ein Mindestalter von 18 Jahren und selbstverständlich ist eine gute Gesundheit für die Arbeit mit den Tieren unerlässlich. Die Temperaturen von oft über 30° Celsius und Luftfeuchtigkeit von 65-90% können den Körper teilweise stark belasten. Qualifikationen in Form von Vorerfahrungen oder Kenntnissen sind nicht notwendig.",
  work: "In welches der Center man möchte, kann man selber wählen. Die Arbeitszeit beträgt meist etwa neun Stunden pro Tag, wobei Pausen von bis zu zweieinhalb Stunden eingeplant werden. Volunteers kümmern sich um die jeweils zu betreuenden Tiere, gehen mit ihnen auch auf Spaziergänge, säubern die Lebensräume, halten sie instand und bereiten Mahlzeiten vor.",
  accomodation: "Die Unterbringungsarten sind sehr unterschiedlich je nach gewähltem Projektcenter, meist aber in Schlafsälen. Die Unterkünfte haben je nach Projekt teilweise keine Elektrizität und keinen Handyempfang. Auch fließend Wasser steht nicht überall zur Verfügung, sondern kommt je nach Projekt aus dem Brunnen oder Fluss.",
  costs: "Ein Mindestaufenthalt von 14 Tagen besteht, abgesehen vom Puma-Center. Je nach Dauer können die Kosten variieren. Hier aufgeführt sind Beispiele in der Landeswährung Boliviano:\n
  1.770 Bs für 15 Nächte\n
  3.770 Bs für 30 Nächte",
  address: "Casilla 1600\n
  Cochabamba\n
  Bolivia",
  tel: "+591 4 413 6572", email: "info@intiwarayassi.org", webpage: "http://www.intiwarayassi.org/",
  min_weeks: 2, costs_week: 115, accom_standard: "einfach", lat: "-16.9717533", lgt: "-65.4117125",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Verpflegung inklusive']),
...
Project.create(title: "Caño Palma Biological Station, Tortuguero, Costa Rica", preview: "Tropischen Regenwald erforschen",
  ...
  qualification: "Gute körperliche Gesundheit ist natürlich Grundvoraussetzung. Tropische Temperaturen sollten einem außerdem wenig ausmachen. Besondere Qualifikationen und Kenntnisse werden beim individuellen Einsatz der Volunteers gerne versucht zu berücksichtigen. Spanischkenntnisse sind von Vorteil, aber nicht Voraussetzung.",
  work: "Je nach Projekt fallen die Aufgaben sehr unterschiedlich aus. Zur Beobachtung einzelner Tierarten werden Wanderungen von drei bis zwölf Kilometern durch den Regenwald und entlang der Strände unternommen. Aber auch bei der Instandhaltung der Wege, der Aufzeichnung von Wetterdaten, dem Abwasch und Kochen oder dem Vorbereiten der Unterkünfte für neu ankommende Forscher werden Volunteers einbezogen. Dazu kommen Vorbereitungen von Unterrichtsstunden zur Aufklärung an der örtlichen Schule.",
  accomodation: "Die Mitarbeiter werden in einer Gemeinschaftsunterkunft mit bis zu 30 Personen in einem Schlafsaal untergebracht. Elektrizität, fließend Wasser, eine Waschmaschine und Internet sind vorhanden. Eine große Küche dient als Gemeinschaftsraum.",
  costs: "250 USD pro Woche inklusive Unterkunft und Verpflegung\n
  Zehn Tage Mindestaufenthalt",
  address: "P.O. Box 335\n
  Pickering, Ontario, L1V 2R6\n
  Canada",
  tel: "+1 905 831 8809", email: "info@coterc.org", webpage: "http://www.coterc.org/",
  min_weeks: 2, costs_week: 225, accom_standard: "einfach", lat: "10.5944586", lgt: "-83.5571152",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Elektrizität', 'Fließend Wasser', 'Waschmaschine', 'Internet', 'Gemeinschaftsräume']),
...
Project.create(title: "Mindo Sacha Urco, Mindo, Ecuador", preview: "Nebelwald und heimische Tiere schützen",
  ...
  qualification: "Generell sind alle Naturfreunde ab einem Alter von 18 Jahren gerne gesehen. Besondere Qualifikationen von zum Beispiel Biologen, Fotografen und Landwirten können sehr gut in der Arbeit vor Ort eingebracht werden.",
  ...
  accomodation: "Die Unterbringung erfolgt in Holzhütten und ist bodenständig mit Schlafsälen und Gemeinschaftsbädern.",
  costs: "100 USD pro Woche\n
  Zwei Wochen Mindestaufenthalt",
  address: "Calle Gonzales Suarez Oe5-197 y Joaquin Castro\n
  Tumbaco, Pichincha, Quito\n
  Ecuador",
  tel: "+593 9 8193 1685", email: "info@mindosachaurco.org", webpage: "http://www.mindosachaurco.org/",
  min_weeks: 2, costs_week: 100, accom_standard: "einfach", lat: "-0.048717", lgt: "-78.775198",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Internet', 'Telefon', 'Freizeitaktivitäten in direkter Umgebung', 'Soziale Infrastruktur in direkter Umgebung']),
...
Project.create(title: "Cape Tribulation Research Station, North Queensland, Australien", preview: "Regenwald und Fledermäuse studieren",
  ...
  qualification: "Die Qualifikationen sind je nach Forschungsprojekt sehr unterschiedlich. Volunteers sollten sich wohl fühlen, sowohl eigenverantwortlich alleine als auch im Team zu arbeiten. Eine Tollwutimpfung ist notwendig.",
  work: "Die Arbeit kann je nach Aufgabengebiet allein oder auch im Team stattfinden. Hierzu gehören Aufgaben wie Radarortung von Fledermäusen, Aufforstung des Regenwaldes, Baumzählungen, Instandhaltungsarbeiten an der Forschungsstation und der Betrieb des angeschlossenen Besucherzentrums mit Fledermäusen und Flughunden.",
  accomodation: "Bis zu zwanzig Personen finden in einfach gehaltenen Schlafbaracken in unterschiedlich großen Räumen, auch Doppelzimmern, ihre Unterkunft. Fließend Wasser und solarbetriebene Heißwasserduschen sowie Waschmaschinen und entsprechend Elektrizität sind vorhanden.",
  costs: "40 AUD pro Tag, inklusive Verpflegung und Unterkunft\n
  Die normale Aufenthaltsdauer beträgt zwei bis drei Wochen.",
  address: "Australian Tropical Research Foundation Limited\n
  PMB 5\n
  Cape Tribulation, QLD 4873\n
  Australia",
  tel: "+61 7 4098 0063", email: "hugh@austrop.org.au", webpage: "http://www.austrop.org.au/",
  min_weeks: 0, costs_week: 200, accom_standard: "mittel", lat: "-16.0784674", lgt: "145.4688279",
  accoms: Accom.where(name: ['Mehrbettzimmer/Schlafsaal', 'Doppelzimmer', 'Fließend Wasser', 'Warmwasser', 'Waschmaschine', 'Elektrizität']),
...
Project.create(title: "Kianjavato Ahmanson Field Station, Kianjavato, Madagaskar", preview: "Regenwald aufforsten und bewahren",
  ...
  Antananarivo",
  tel: "+1 402 738 2095", email: "mbp@madagascarpartnership.org", webpage: "http://madagascarpartnership.org/volunteering/",
  min_weeks: 26, costs_week: 30, accom_standard: "einfach", lat: "-21.3802362", lgt: "47.8668153",
  accoms: Accom.where(name: ['Zelt', 'Elektrizität', 'Verpflegung inklusive']),
